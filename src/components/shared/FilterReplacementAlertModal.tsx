...
interface FilterReplacementAlertModalProps {
  onDismiss: () => void
}

export function FilterReplacementAlertModal({ onDismiss }: FilterReplacementAlertModalProps) {
      ...
      <div className="relative z-10 w-full max-w-sm rounded-xl border border-border bg-card shadow-xl">
        ...
        <div className="px-4 py-4">
          <p className="text-sm text-foreground">
            Your filter replacement is overdue. Replace the filter soon to maintain water quality.
          </p>
        </div>
